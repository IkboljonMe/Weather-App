...
export default function HomeScreen() {
  ...
  const saveHomeLocation = async (location: any) => {
    try {
  ...
  const toggleShowMores = (index: any) => {
    setExpandedDays((prevState: any) => ({
      ...prevState,
  ...
  const handleSearch = async (newLocation: any) => {
  ...
  const renderForecastItem = (item: any, index: any) => {
    const isExpanded: any = expandedDays[index];
    return (
      <TouchableOpacity
        key={index}
